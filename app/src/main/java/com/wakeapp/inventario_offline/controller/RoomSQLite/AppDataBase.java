...
@Database(entities = {MovilDB.class, NotebookDB.class, OtherDB.class, ResponsableDB.class, ToolDB.class, UbicationDB.class, UserDB.class}, version = 1, exportSchema = false)
